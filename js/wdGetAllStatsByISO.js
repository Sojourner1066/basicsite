...
export async function wdGetAllStatsByISO(iso3="NGA") {
    // This query returns the population, development index, and GDP for a given ISO code
    const query = `SELECT ?country ?countryLabel ?isoCode ?population ?ihdi ?hdi ?gdp ?gdpYear WHERE {
            VALUES ?isoCode { "AFG" "ALA" "ALB" "DZA" "ASM" "AND" "AGO" "AIA" "ATA" "ATG"
